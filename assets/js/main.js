  ...
  const AR = {
    ...
    "Home Maintenance, Furniture & Moving, and Deep Cleaning Services in Dubai & Sharjah":"صيانة منزلية، خدمات أثاث ونقل، وتنظيف عميق في دبي والشارقة",
    "Our Specialties":"تخصصاتنا",
    "Interior Design, Majlis Construction, Swimming Pool & Landscaping Specialties Across the UAE":"تصميم داخلي، إنشاء مجالس، ومسابح وتنسيق حدائق في جميع أنحاء الإمارات",
